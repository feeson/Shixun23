onload = () => {
    ...
    if (user) {
        ...
        $('#startTimeVal').val(user.startTime)
        $('#endTimeVal').val(user.endTime)
    }
}
...
const handleCreateUser = () => {
    ...
    if (!($('#startTimeVal').val() && new Date($('#startTimeVal').val()).getTime())) return alert('开始时间不能为空！')
    if (!($('#endTimeVal').val() && new Date($('#endTimeVal').val()).getTime())) return alert('结束时间不能为空！')
    ...
    user.startTime = $('#startTimeVal').val() && new Date($('#startTimeVal').val()).getTime();
    user.stopTime = $('#endTimeVal').val() && new Date($('#endTimeVal').val()).getTime();
